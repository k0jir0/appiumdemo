...
//Note: Runs into a SikuliX/MacOS incompatibility regarding mouse access.
...
public class AutomationTestSikuliX {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("1. Configure Capabilities to Target Device");
            ...
            System.out.println("6. Run Test Function Beta");
    ...
    final static Logger logger = LoggerFactory.getLogger(AutomationTestSikuliX.class);
    ...
    public static void executeAppiumTest() throws SikuliException {
        ...
        try {
            ...
            //sequence.addAction(pointer.createPointerMove(Duration.ofMillis(200), PointerInput.Origin.pointer(), 915, 80));
            ...
            // Perform the final click action at the specified coordinates
            sequence.addAction(new Pause(pointer, Duration.ofSeconds(8)));
            ...
            */
            ...
            sequence.addAction(screenshotCall(screen)); 
            sequence.addAction(new Pause(pointer, Duration.ofSeconds(15)));
            ...
            */
            ...
            // Find the element by its ID and print
    ...
    public static Interaction screenshotCall(Screen screen){
        try {
            ScreenImage screenshot = screen.capture();
            String folderPath = "screens"; //Targets the screens folder at the project root
